...
//       <div>
//         <h3>HYBRID CLOUD</h3>
//         <h2>Your Partner in World-Class <br/>Training and Development</h2>
//         <p style={{width:"600px"}}>Welcome to Hybrid Cloud, your trusted tech education hub in Mahe. We offer personalized, hands-on training in AWS, Azure, Google Cloud, Java, Terraform, Kubernetes, Python. Our curriculum blends real-world projects with expert guidance to build job-ready skills. Join a collaborative community, earn industry-recognized certifications, and advance your career in today’s competitive, cloud-driven world—all in</p>
...
//       <div>
//         <h6>WHY CHOOSE Cloud Institution</h6>
//         <h4>WHY CHOOSE Cloud Institution The Cloud Institution Advantage: Empowering Your Tech Journey</h4>
//       </div>
//       <div className="icon-wrapper pink" style={{display:"flex"}}>
//         <Card style={{ width: '18rem', height:'28rem'}}>
//       <Card.Img variant="top" style={{height:"100%"}} src={"src/assets/expert instructor.png" }/>
//       <Card.Body>
...
//       <Card.Img variant="top" src="holder.js/100px180" />
//       <Card.Body>
//         <Card.Title>Flexible Learning Options</Card.Title>
//         <Card.Text>
...
//       <Card.Img variant="top" src="holder.js/100px180" />
//       <Card.Body>
//         <Card.Title>Career Support</Card.Title>
//         <Card.Text>
...
//         <p>At  Hybrid Cloud , our Cloud Computing Training offers a truly transformative learning experience. You’ll gain comprehensive knowledge of cloud technologies, develop hands-on skills, and acquire valuable industry insights. Our training is designed to prepare you for real-world challenges and includes certification opportunities that significantly boost your professional profile.</p>
//       </div>
//       <div>
//         <h6>Why Choose Cloud Institution?</h6>
//         <ul>
//             <li>100% Placement Support Upon Course Completion</li>
//             <li>Preparation for Global Certification Exams</li>
//             <li>Clear Understanding of Complex Technical Concepts</li>
//             <li>Resume Building & Interview Preparation Assistance</li>
//             <li>Industry-Integrated Labs and Projects</li>
//             <li>Cloud Computing Certification Awarded After Course Completion</li>
//         </ul>
//         <p>Join Hybrid Cloud  to stay ahead in the rapidly evolving field of cloud computing and take confident steps toward a successful career.</p>
//       </div>
//       <div style={{display:"flex",backgroundColor:"lightblue"}}>
//       <div>
//         <img src={"src/assets/hybrid.svg"} alt="" />
            ...
            <Col md={4} className="mb-4">
              ...
              onMouseLeave={(e) => e.currentTarget.style.transform = 'translateY(0)'}>
                <Card.Img 
                  ...
                  src={"src/assets/expert instructor.png"}
                />
