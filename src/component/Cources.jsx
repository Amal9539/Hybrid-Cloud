...
//       <Card.Img variant="top" src="src/assets/ma.webp" style={{height:"170px"}} />
//       <Card.Body>
...
//       <Card.Img variant="top" src="src/assets/aws.webp" style={{height:"170px"}} />
//       <Card.Body>
...
//     </Card>
//     <Card style={{ width: '18rem' }}>
//       <Card.Img variant="top" src="src/assets/gcloud.webp" style={{height:"170px"}}/>
//       <Card.Body>
...
//     </Card>
//     <Card style={{ width: '18rem' }}>
//       <Card.Img variant="top" src="src/assets/java.webp" style={{height:"170px"}} />
//       <Card.Body>
...
//     </Card>
//     <Card style={{ width: '18rem' }}>
//       <Card.Img variant="top" src="src/assets/python1.webp" style={{height:"170px"}} />
//       <Card.Body>
...
//     </Card>
//     <Card style={{ width: '18rem' }}>
//       <Card.Img variant="top" src="src/assets/devopss.webp" style={{height:"170px"}} />
//       <Card.Body>
...
//     </Card>
//     <Card style={{ width: '18rem' }}>
//       <Card.Img variant="top" src="src/assets/tera.png" style={{height:"170px"}} />
//       <Card.Body>
...
//     <Card style={{ width: '18rem' }}>
//       <Card.Img variant="top" src="src/assets/kuber.png" />
//       <Card.Body>
...
//             <img src="src/assets/icons8-location-96.png" style={{height:"30px"}} alt="" />
//             <p style={{marginLeft:"20px"}}>Anandam realty, palloor, Mahe - 673310</p>
//             </div>
//              <div style={{display:"flex"}}>
//             <img src="src/assets/icons8-email-24.png" style={{height:"30px"}} alt="" />
//             <p style={{marginLeft:"20px"}}>Anandam realty, palloor, Mahe - 673310</p>
//             </div>
//             <div style={{display:"flex"}}>
//             <img src="src/assets/icons8-phone-50.png" style={{height:"30px"}} alt="" />
  ...
  const courseData = [
    {
      ...
      duration: '50hr',
      image: 'src/assets/ma.webp',
      link: '/azure'
    },
    {
      title: 'AWS Certificate Training',
      duration: '50hr',
      image: 'src/assets/aws.webp',
      link: '/amazone'
    },
    {
      title: 'Google Cloud Platform Training',
      duration: '50hr',
      image: 'src/assets/gcloud.webp',
      link: '/google'
    },
    {
    ...
    },
    {
      ...
      duration: '100hr',
      image: 'src/assets/python1.webp',
      link: '/python'
    },
    {
      title: 'DevOps Training',
      duration: '45hr',
      image: 'src/assets/devopss.webp',
      link: '/devops'
    },
    {
